...
from .panel import (
	...
	GITBLEND_UL_stash_list,
	GITBLEND_MT_stash_specials,
)
...
def register_prefs():
	...
	bpy.utils.register_class(GITBLEND_StashEntry)
	bpy.utils.register_class(GITBLEND_Properties)
	bpy.utils.register_class(GITBLEND_UL_commit_history)
	bpy.utils.register_class(GITBLEND_UL_stash_list)
	bpy.utils.register_class(GITBLEND_MT_stash_specials)
...
def unregister_prefs():
	...
	bpy.utils.unregister_class(GITBLEND_MT_stash_specials)
	bpy.utils.unregister_class(GITBLEND_UL_stash_list)
